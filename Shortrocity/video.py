...
def create(output_video_path):
    ...
    fourcc = cv2.VideoWriter_fourcc(*'XVID') # YOU can change the codec to mp4v, etc.
    temp_video_path = 'vertical_video.avi'
    ...
    text.add_narration_to_video(temp_video_path, output_video_path)
    os.remove(temp_video_path)
# create('hwfinal_video.avi')
